...
output_path <- file.path(base_path, "plot3.png")
...
with(selection, plot(DateTime, Sub_metering_1, type="l", xlab="", ylab="Energy sub metering", main = ""))
with(selection, lines(DateTime, Sub_metering_2, type="l", col="red"))
with(selection, lines(DateTime, Sub_metering_3, type="l", col="blue"))
