...
output_path <- file.path(base_path, "plot1.png")
...
with(selection, hist(Global_active_power, xlab="Global Active Power (kilowatts)", ylab="Frequency", col="red", main = "Global Active Power"))
dev.off()
